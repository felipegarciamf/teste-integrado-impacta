...
public class CrudUserSteps {
	...
	@Given("^user would like to see all user$")
	public void userWouldLikeToSeeAllUser() throws Throwable {
		User.clearFields();
	}

	@When("^user access user page$")
	public void userAccessUserPage() throws Throwable {
		RESTSupport.executeGet(User.getEndPoint() + ".json");
	}

	@Given("^user would like to see all user number (.*)$")
	public void userWouldLikeToSeeAllUserNumber(String number) throws Throwable {
